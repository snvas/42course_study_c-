...
{
	std::size_t left = (std::size_t)leftp;
	std::size_t right = (std::size_t)rightp;
	if (left < right)
		return -1;
	else if (left > right)
		return 1;
